...
from models.utils import save_model, loss_visual
...
class Trainer():
    def __init__(self, model: nn.Module, train_dataset, test_dataset, device_name='cpu',
                 lr=0.001, weight_decay=1e-2, trained_model_path=None, continue_train=False, save_path=''):
        self.model = model
    ...
    def train(self, context: Optional[Context]):
        ...
        elif type(self.train_dataset) is not list:
    ...
    def info_solve(self, context: Optional[Context]):
        ...
        loss_visual(loss_total, test_loss_total, self.save_path)
        loss_total.clear()
